...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2024 at 05:57 AM
...
INSERT INTO `notes` (`notes_id`, `user_id`, `title`, `description`, `created_at`) VALUES
(18, 17, 'my first note', 'kapoy pero bawal sumuko', '2024-04-19 00:29:11'),
...
(39, 14, 'erwer', 'ewrewr', '2024-04-23 03:39:51');
...
--
ALTER TABLE `notes`
  MODIFY `notes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
